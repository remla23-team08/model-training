...
**Project** | **Details**
--------|--------
Date    | Wed, 21 Jun 2023 14:31:09 +0200 
...
Git: Commit     | `bfac48b233b86619b9960dda8e63c0f2c4099a51`
Git: Branch     | `pytest`
...
This equates to **22.222222%** of Python files in your project being tests, which meets the target ratio of **20%**
...
Your project's tests achieved **17.9%** line test coverage, but **80.0%** is the target amount of test coverage to beat. You'll need to further improve your tests.
