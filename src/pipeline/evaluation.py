...
def model_eval(classifier, set_path='data/external/a1_RestaurantReviews_HistoricDump.tsv', split=0.1, state=0):
    ...
    # Load CV
    count_vectoriser = joblib.load(os.path.join(root_path, '..', '..', 'data', 'models', 'c1_BoW_Sentiment_Model.pkl'))
...
if __name__ == "__main__":
    model = joblib.load(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..',
